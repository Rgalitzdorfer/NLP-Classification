...
X = data.drop(columns=['Label', 'Text']) #Drop Target Column and Text Column
...
combined_predictions.to_csv(f'{output_directory}/Predictions_MLR_No_Text.csv', index=False)
