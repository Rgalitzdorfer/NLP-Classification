...
grid_search = GridSearchCV(estimator=svm_classifier, param_grid=param_grid, cv=cv, n_jobs=-1, verbose=2)
...
combined_predictions.to_csv(f'{output_directory}/Predictions_SVM.csv', index=False)
